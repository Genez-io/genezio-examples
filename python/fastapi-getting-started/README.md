...
# Genezio FastApi on Getting Started

In the `index.py` file, you will see the implementation of a FastApi app that has three routes:
...
[![Deploy to Genezio](https://raw.githubusercontent.com/Genez-io/graphics/main/svg/deploy-button.svg)](https://app.genez.io/start/deploy?repository=https://github.com/Genez-io/fastapi-getting-started)
