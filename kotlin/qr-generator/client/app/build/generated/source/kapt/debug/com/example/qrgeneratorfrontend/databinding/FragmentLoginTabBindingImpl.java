...
public class FragmentLoginTabBindingImpl extends FragmentLoginTabBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.login_email, 1);
        sViewsWithIds.put(R.id.login_password, 2);
        sViewsWithIds.put(R.id.login_button, 3);
        sViewsWithIds.put(R.id.progressLogin, 4);
    }
    // views
    @NonNull
    ...
    public FragmentLoginTabBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private FragmentLoginTabBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
